...
# use this commend ./build_llvm.sh /root/workspace/llvm-project /root/workspace/llvm-project/build /root/workspace/llvm-project/build
if [[ $# -ne 3 ]] ; then
...
/opt/cmake/bin/cmake --build "$build_dir" --target opt mlir-opt mlir-translate install
ninja -j 12 install 